    ...
    9728: (e,t)=>{
        ...
        class baseTabs extends elementorModules.frontend.handlers.Base {
            ...
            activateTab(e) {
                ...
                i[t.showTabFn](o, (()=>elementorFrontend.elements.$window.trigger("resize"))),
                i.removeAttr("hidden")
            }
            isActiveTab(e) {
    ...
    5914: (e,t)=>{
        ...
        class ImageCarousel extends elementorModules.frontend.handlers.SwiperBase {
            ...
            async onInit(...e) {
                ...
                this.swiper = await new s(this.elements.$swiperContainer,this.getSwiperSettings()),
    ...
    5363: (e,t)=>{
        ...
        class Video extends elementorModules.frontend.handlers.Base {
            ...
            prepareYTVideo(e, t) {
                ...
                s.yt_privacy && (n.host = "https://www.youtube-nocookie.com",
    ...
    4508: (e,t,s)=>{
        ...
        class IconsManager {
            ...
            createSvgNode(e, {props: t={}, attrs: s={}}) {
                ...
                return Object.keys(t).map((e=>n[e] = t[e])),
    ...
    3896: (e,t,s)=>{
        ...
        e.exports = elementorModules.ViewModule.extend({
            ...
            setHTMLContent: function(e) {
                window.elementorCommon && elementorCommon.helpers.hardDeprecated("elementorFrontend.utils.lightbox.setHTMLContent", "3.1.4"),
            ...
            setVideoContent: function(e) {
                ...
                o.onHide = function() {
                    ...
                    this.$buttons = jQuery(),
                    this.focusedButton = null,
                    o.getElements("message").removeClass("elementor-fit-aspect-ratio")
                }
            },
            ...
            createShareLink: function(e, t, s=null) {
                const n = {};
                return "pinterest" === e ? n.image = encodeURIComponent(t) : n.url = encodeURIComponent(location.href.replace(/#.*/, "") + s),
            ...
            getSlideshowHeader: function() {
                ...
                if (s || n || o || r) {
                    ...
                    if (o) {
                        ...
                        n.push(d.$iconZoom),
                        this.isFontIconSvgExperiment && (d.$iconZoomOut = t(i.zoomOutBold.element).attr(o).addClass(a.hidden).on("click", this.toggleZoomMode),
                    ...
                    if (n) {
                        ...
                        d.$iconExpand = t(s).append(t("<span>"), t("<span>")).attr(r).on("click", this.toggleFullscreen),
                        n.push(d.$iconExpand),
                        this.isFontIconSvgExperiment && (d.$iconMinimize = t(i.frameMinimize.element).attr(o).addClass(a.hidden).on("click", this.toggleFullscreen),
            ...
            activateFullscreen: function() {
                const e = this.getSettings("classes");
                n.default.request(this.elements.$container.parents(".dialog-widget")[0]),
            ...
            setSlideshowContent: function(e) {
                const {i18n: t} = elementorFrontend.config
                  ...
                  , r = "" !== elementorFrontend.getKitSettings("lightbox_description_src")
                  , a = o || r
                ...
                if (e.slides.forEach((e=>{
                    ...
                    if (e.video) {
                        ...
                        e.title && (i["data-title"] = e.title,
                        i.alt = e.title),
                        e.description && (i["data-description"] = e.description,
                        i.alt += " - " + e.description);
                        const r = s("<img>", i);
                        t.append([r, n]),
                        o.append(t)
            ...
            activeKeyDown: function(e) {
                ...
                if (9 === e.which) {
                    ...
                    t.last().trigger("focus")) : !i && s || (e.preventDefault(),
            ...
            playSlideVideo: function() {
                ...
                n.append(i),
                e.append(n),
                -1 !== t.indexOf("vimeo.com") ? (r = "vimeo",
                a = elementorFrontend.utils.vimeo) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (r = "youtube",
